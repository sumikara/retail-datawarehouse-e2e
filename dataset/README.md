...
This dataset adaptation was a educational design choice for the DWH project. The goal was not to preserve the Kaggle file exactly as published, but to transform a simulated retail dataset into a more suitable multi-source warehouse scenario with:
